...
<head>
    ...
    <title>HOTEL MARINA INTERNATIONAL LIMITED</title>
	<!-- Bootstrap Styles-->
						...
						<form name="form" method="post">
                            <div class="form-group">
                                            ...
                                            <select name="troom"  class="form-control" required>
												...
												<option value="Guest House">TRIPPLE HOUSE</option>
												<option value="Single Room">FAMILLY ROOM</option>
                                            </select>
                              </div>
								...
								<div class="form-group">
                                            ...
                                            <select name="bed" class="form-control" required>
												...
												<option value="Triple">TRIPPLE</option>
                                                <option value="Quad">FAMILLY</option>
