...
@page { margin: 0; }
	...
	?>
		<header>
			<h1>Invoice</h1>
			<address >
				<p>Hotel Marina International Ltd</p>
				<p>Kakrail Rd,<br>Dhaka 1205,<br>Bhuiya Mention, <br>Inside Rajmoni Cinema Hall.</p>
				<p>Mobile: 01608964206</p>
				<p>Skype: Marianabooking</p>
				<p>reservations@hotelmarina.com</p>
			</address>
			<span><img alt="" src="assets/img/logo"></span>
		</header>
		<article>
			<h1>Recipient</h1>
			<address >
		...
		<aside>
			...
			<div >
				<p align="center">Email :- info@hotelmarinabd.com || Web :- www.hotelmarinabd.com || Phone :- reservations@hotelmarina.com</p>
			</div>
		</aside>
	</body>
</html>
