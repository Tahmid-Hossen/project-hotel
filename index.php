...
<html lang="en">
<head>
<title>HOTEL MARINA INTERNATIONAL</title>
<!-- for-mobile-apps -->
...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:info@example.com">INFO@HOTELMARINABD.COM</a></li>
					<li><i class="fa fa-phone" aria-hidden="true"></i><span style="color: #fff;">01608964206</span></li>	
					<li class="s-bar">
						<div class="search">
	...
	<div class="w3_navigation" style="height:100px;">
		<div class="container">
					...
					<div class="price-block agile">
						...
						<div class="price-gd-bottom">
							...
							<div class="price-selet">	
								<h3><span>TK: </span>3000 per night</h3>						
				...
				<div class="col-md-3 price-grid ">
					<div class="price-block agile">
						...
						<div class="price-gd-bottom">
							...
							<div class="price-selet">
								<h3><span>TK: </span>4000 per night</h3>
								<a href="admin/reservation.php" >Book Now</a>
							</div>
						</div>
					</div>
				...
				<div class="col-md-3 price-grid lost">
					<div class="price-block agile">
						...
						<div class="price-gd-bottom">
							...
							<div class="price-selet">
							<h3><span>TK: </span>4500 per night</h3>
								<a href="admin/reservation.php" >Book Now</a>
							</div>
						</div>
					</div>
				...
				<ul class="cbp-ig-grid">
					<li>
						<div class="w3_grid_effect">
							...
							<span class="cbp-ig-category">Hotel Marina International Limited</span>
						</div>
					</li>
					<li>
						<div class="w3_grid_effect">
		 ...
		 <h3 class="title-w3-agileits title-black-wthree">Our Gallery</h3>
				<div class="col-md-3 gallery-grid gallery1">
					<a href="images/g1.jpg" class="swipebox"><img src="images/g1.jpg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>Hotel Marina International Limited</h4>
				...
				<div class="col-md-3 gallery-grid gallery1">
					<a href="images/g4.jpg" class="swipebox"><img src="images/g13.jpg" class="img-responsive" alt="/">
						<div class="textbox">
						   <h4>Hotel Marina International Limited</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
						</div>
				...
				<div class="col-md-3 gallery-grid gallery1">
					<a href="images/g4.jpg" class="swipebox"><img src="images/g14.jpg" class="img-responsive" alt="/">
						<div class="textbox">
						   <h4>Hotel Marina International Limited</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
						</div>
				...
				<div class="col-md-3 gallery-grid gallery1">
					<a href="images/g4.jpg" class="swipebox"><img src="images/g15.jpg" class="img-responsive" alt="/">
						<div class="textbox">
						   <h4>Hotel Marina International Limited</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
						</div>
				...
				<div class="col-md-3 gallery-grid gallery1">
					<a href="images/g4.jpg" class="swipebox"><img src="images/g16.jpg" class="img-responsive" alt="/">
						<div class="textbox">
						   <h4>Hotel Marina International Limited</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
						</div>
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>01608964206</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:reservations@hotelmarinabd">reservations@hotelmarinabd.com</a></p>
			<p class="contact-agile1"><strong>Address :</strong> Kakrail Rd, Dhaka 1205, Bhuiya Mention, 9th Floar, Inside Rajmoni Cinema Hall.</p>
...
<!-- /contact -->
			<div class="copy">
		        <p>© 2020 Hotel Marina International LTD . All Rights Reserved | Design by <a href="index.php">Webamex</a> </p>
		    </div>
<!--/footer -->
<!-- js -->
